...
def tabular_q_learning(q_func, current_state_1, current_state_2, action_index,
    ...
    q_func[current_state_1, current_state_2, action_index, object_index] = (1 - ALPHA) * q_func[current_state_1, current_state_2, action_index, object_index] + ALPHA * (reward + GAMMA*max_q)
...
def run_episode(for_training):
    ...
    while not terminal:
        ...
        if for_training:
            # update Q-function.
            tabular_q_learning(q_func, current_room_desc_index, current_quest_desc_index, next_action_index, next_object_index, reward, next_room_desc_index, current_quest_desc_index, terminal)
