...
def deep_q_learning(current_state_vector, action_index, object_index, reward,
    ...
    max_q_next = 1 / 2 * (q_values_action_next.max()
    ...
    max_q = 0.0 if terminal else max_q_next
    y = reward + GAMMA * max_q  # Target
...
def run_episode(for_training):
    ...
    while not terminal:
        ...
        next_action_index, next_object_index = epsilon_greedy(current_state_vector, epsilon)
